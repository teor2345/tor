...
extern "C" {
    ...
    fn crypto_digest_algorithm_get_name(
        alg: digest_algorithm_t,
    ) -> *const c_char;
    ...
    fn crypto_digest256_new(
        algorithm: digest_algorithm_t,
    ) -> *mut crypto_digest_t;
    fn crypto_digest512_new(
        algorithm: digest_algorithm_t,
    ) -> *mut crypto_digest_t;
    fn crypto_digest_free_(digest: *mut crypto_digest_t);
    fn crypto_digest_add_bytes(
        digest: *mut crypto_digest_t,
        data: *const c_char,
        len: size_t,
    );
    fn crypto_digest_get_digest(
        digest: *mut crypto_digest_t,
        out: *mut c_char,
        out_len: size_t,
    );
    fn crypto_digest_dup(
        digest: *const crypto_digest_t,
    ) -> *mut crypto_digest_t;
    fn crypto_digest_assign(
        into: *mut crypto_digest_t,
        from: *const crypto_digest_t,
    );
    ...
    fn crypto_xof_add_bytes(
        xof: *mut crypto_xof_t,
        data: *const uint8_t,
        len: size_t,
    );
    fn crypto_xof_squeeze_bytes(
        xof: *mut crypto_xof_t,
        out: *mut uint8_t,
        len: size_t,
    );
