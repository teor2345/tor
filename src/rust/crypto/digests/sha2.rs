...
mod test {
    ...
    fn sha256_digest() {
        ...
        let expected = [
            151, 223, 53, 136, 181, 163, 242, 75, 171, 195, 133, 27, 55, 47,
            11, 167, 26, 157, 205, 222, 212, 59, 20, 185, 208, 105, 97, 191,
            193, 112, 125, 157,
        ];
    ...
    fn sha512_digest() {
        ...
        let expected = [
            203, 55, 124, 16, 176, 245, 166, 44, 128, 54, 37, 167, 153, 217,
            233, 8, 190, 69, 231, 103, 245, 209, 71, 212, 116, 73, 7, 203, 5,
            89, 122, 164, 237, 211, 41, 160, 175, 20, 122, 221, 12, 244, 24,
            30, 211, 40, 250, 30, 121, 148, 38, 88, 38, 179, 237, 61, 126, 246,
            240, 103, 202, 153, 24, 90,
        ];
