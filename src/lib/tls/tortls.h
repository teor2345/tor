...
tor_tls_context_t *tor_tls_context_get(bool is_server);
tor_tls_t *tor_tls_new(tor_socket_t sock, bool is_server);
void tor_tls_set_logged_address(tor_tls_t *tls, const char *address);
void tor_tls_set_renegotiate_callback(tor_tls_t *tls,
                                      void (*cb)(tor_tls_t *, void *arg),
                                      void *arg);
bool tor_tls_is_server(tor_tls_t *tls);
...
bool tor_tls_peer_has_cert(tor_tls_t *tls);
...
bool tor_tls_used_v1_handshake(tor_tls_t *tls);
int tor_tls_get_num_server_handshakes(tor_tls_t *tls);
bool tor_tls_server_got_renegotiate(tor_tls_t *tls);
...
bool evaluate_ecgroup_for_tls(const char *ecgroup);
